...
Shri S.K.Pankaj,AM(PU)R.B. Visits ICF</a>
 ...
 <li class="nav-item dropdown">
  ...
  <div class="pdf-container">
    <h1 class="pdf-title">Laptop Details</h1>
    <ul class="pdf-list">
      <li><a href="http://10.53.4.11/newicf/secretariat/laptop/Procurement_of_Laptop.pdf" class="pdf-link pdf-link-1" target="_blank">Procurement of Laptops</a></li>
      <li><a href="http://10.53.4.11/newicf/secretariat/laptop/Laptop_Policy_Letter_23012012.pdf" class="pdf-link pdf-link-2" target="_blank">Laptop Policy Letter</a></li>
      <li><a href="http://10.53.4.11/newicf/secretariat/laptop/Simplification_Procedure_Laptop_Reimbursement.pdf" class="pdf-link pdf-link-3" target="_blank">Simplification of the procedure of Laptop Reimbursement</a></li>
      <li><a href="http://10.53.4.11/newicf/secretariat/laptop/Laptop_130820.pdf" class="pdf-link pdf-link-4" target="_blank">Provision of Laptop to Gazetted Officers in ICF</a></li>
    </ul>
  </div>
</div>
