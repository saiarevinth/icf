            ...
            <nav class="mobile-nav">
                ...
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="aboutSubmenu">
                        <a href="http://10.53.4.11/newicf/about_icf.php" class="mobile-menu-link">About ICF</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="aboutSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">About ICF</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Our General Manager</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">75000th Coach Production</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">GM Speech-Republic Day</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">GM Speech-Independence Day</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Milestones</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Exports</a></div>
                    </div>
                </div>
                <div class="mobile-menu-item">
                    <a href="#" class="mobile-menu-link">G.M. Secretariat</a>
                </div>
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="deptSubmenu">
                        <a href="#" class="mobile-menu-link">Department</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="deptSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Mechanical</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Electrical</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Engineering</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Stores</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Personnel</a></div>
                    </div>
                </div>
                <div class="mobile-menu-item">
                    <a href="#" class="mobile-menu-link">Personnel Branch</a>
                </div>
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="importantSubmenu">
                        <a href="#" class="mobile-menu-link">Important Links</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="importantSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Online Booking of ORH-ICF</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">IT Centre Help Desk Portal</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">IT Asset Management</a></div>
                    </div>
                </div>
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="externalSubmenu">
                        <a href="#" class="mobile-menu-link">External Links</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="externalSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 1</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 2</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 3</a></div>
                    </div>
                </div>
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="tendersSubmenu">
                        <a href="#" class="mobile-menu-link">Tenders</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="tendersSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Current Tenders</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Past Tenders</a></div>
                    </div>
                </div>
                <div class="mobile-menu-item">
                ...
                <div class="mobile-menu-item">
                    <div class="mobile-dropdown-toggle" data-submenu="otherSubmenu">
                        <a href="#" class="mobile-menu-link">Other Links</a>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="mobile-submenu" id="otherSubmenu">
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 1</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 2</a></div>
                        <div class="mobile-submenu-item"><a href="#" class="mobile-submenu-link">Link 3</a></div>
                    </div>
                ...
                <div class="mobile-menu-item">
                    <div class="language-selector-mobile">
                        ...
                        <a href="#" class="mobile-lang-link">हिन्दी</a>
                    </div>
                </div>
            </nav>
        </div>
   ...
   <div class="news-ticker-container">
    <div class="news-ticker">
        <a href="http://10.53.4.11/newicf/images/75yrs_of_constitution.rar" target="_blank" style="color: inherit; text-decoration: none;">
            Click here to download the official logo of "75 Years of Constitution" and guidelines for its usage in all official communications
        </a>
    </div>
</div>
...
<div class="calendar-container">
    <div class="calendar-card">
        <div class="card-header">
            <h3 class="card-title">ICF Calendar 2025</h3>
        </div>
        <div class="card-body">
            <div class="holiday-link">
                <p class="holiday-text">List of Holidays - 2025</p>
                <a href="http://10.53.4.11/newicf/pdf/List_of_Holiday-2025.pdf" class="holiday-more">Click here</a>
            </div>

            <div class="holiday-link">
                <p class="holiday-text">ICF Calendar 2025</p>
                <a href="http://10.53.4.11/newicf/pdf/ICF_CALANDAR_2025.pdf" class="holiday-more">Click here</a>
            </div>
            ...
            <!-- Month Heading -->
                    ...
                    <div class="vande-bharat-container">
                        <div class="vande-bharat-card">
                            <div class="card-header">
                                <h3 class="card-title">Vande Bharat</h3>
                            </div>
                            <div class="card-body">
                                <div class="vande-bharat-image">
                                    <img src="image copy 5.png" alt="Vande Bharat Train" class="vande-bharat-img">
                                    <div class="image-overlay">
                                        <a href="http://10.53.4.11/newicf/vbportal/index.html" class="overlay-btn">Click here</a>
                                    </div>
                                </div>
                            </div>
                            <div class="hindi-word-header">
                                <h3 class="hindi-word-title">Today's Hindi Word/आज का शब्द</h3>
                            </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-social">
                    <h3 class="footer-title">Social Media Links</h3>
                ...
                <div class="footer-info">
                    <p class="footer-address">Integral Coach Factory, Chennai - 600038</p>
                    <p class="footer-copyright">Copyright © 2025 Designed, Developed & Maintained by IT Centre-ICF</p>
                </div>
            </div>
        </div>
    </footer>
